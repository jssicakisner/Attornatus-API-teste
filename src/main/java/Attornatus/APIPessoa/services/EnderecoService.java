package Attornatus.APIPessoa.services;

import Attornatus.APIPessoa.models.Endereco;
import Attornatus.APIPessoa.repository.EnderecoRepository;
    ...
    public ResponseEntity<?> salvarEndereco(Endereco endereco) {
        try {
            ...
            return new ResponseEntity<String>(
                    "Dados inválidos! Verificar se os dados informados já foram cadastrados.",
